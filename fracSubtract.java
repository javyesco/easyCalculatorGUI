...
public class fracSubtract extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					fracSubtract frame = new fracSubtract();
	...
	public fracSubtract() {
		...
		JButton btnAddition = new JButton("Subtract");
		btnAddition.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					theResult = newRationalNum.subt(rationalVal1, rationalVal2);
