...
public class fracMultiply extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					fracMultiply frame = new fracMultiply();
	...
	public fracMultiply() {
		...
		JButton btnAddition = new JButton("Multiply");
		btnAddition.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					theResult = newRationalNum.mult(rationalVal1, rationalVal2);
